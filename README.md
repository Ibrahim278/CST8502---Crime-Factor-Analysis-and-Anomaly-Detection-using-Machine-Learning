...
In this group-based project, we sampled 10000 instances from the Police Dataset. Preprocessing was done on the sampled data such as clustering X and Y Coordinates into Zones, Removing redundant DateTime data, dropping missing data and duplicate instances. 
